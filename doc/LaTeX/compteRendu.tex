...
\end{figure}
	...
	Nous allons développer différents modules pour structurer le jeu.
        ...
        Grâce à l'utilisation des événements de la bibliothèque SDL, il a été simple d'implémenter cette fonctionnalitée. Le client rejoins le serveur en 
        ...
        Pour la gestion des objets, compétences, joueurs, qui vous seront présenté ensuite, chaque tuile utilise plusieurs listes génériques. 
        \subsection{Objets}
